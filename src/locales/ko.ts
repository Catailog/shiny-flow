...
export const ko: Translations = {
  ...
  home: {
    ...
    analysisDone: '파일 분석 완료, 스크린샷 캡처 준비 중...',
    capturingScreenshots: (done: number, total: number) => `스크린샷 캡처 중 (${done} / ${total})`,
  ...
  dialog: {
    ...
    comment: {
      ...
      authorChange: '변경',
      authorConfirm: '확인',
      authorUsername: '사용자 이름',
      authorDevice: '기기 이름',
      authorCustomPlaceholder: '이름 입력...',
    },
    edgeComment: {
      title: '엣지 라벨',
      placeholder: '라벨...',
